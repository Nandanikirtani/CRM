          ...
          >
            ...
            {openId === teacher._id && (
              ...
              >
                ...
                <div className="border-t border-slate-200 mt-6 pt-6 flex items-center justify-between gap-4">
                  <div className="min-w-0">
                  ...
                  <div className="bg-green-100 text-green-700 px-6 py-4 rounded-3xl flex items-center gap-3 w-fit">
                    <IndianRupee />
